...
* **(temporary fix)** The `sgm_node` container does not work as it should, so you'll need to manually install the node dependencies via the **host** device with: `cd web && yarn install && cd ..`
